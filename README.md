[![Ember Observer Score](http://emberobserver.com/badges/ember-cli-time-picker.svg)](http://emberobserver.com/addons/ember-cli-time-picker)

# Ember-Cli-Time-Picker
...
```
ember install ember-cli-time-picker
```
